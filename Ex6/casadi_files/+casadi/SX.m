classdef  SX < casadi.MatrixCommon & casadi.GenericExpressionCommon & casadi.GenSX & casadi.PrintableCommon
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(624, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(631, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(632, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(649, varargin{:});
    end
